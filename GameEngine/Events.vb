							...
							For	Each ConvoX In CreatureTarget.Conversations
								For	Each TopicX In ConvoX.Topics
									If InStr(UCase(TopicX.Say), UCase(BreakText(sText, 1))) > 0 Then
										...
										'UPGRADE_WARNING: Couldn't resolve default property of object CreatureTarget.Conversations().RemoveTopic. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
										CreatureTarget.Conversations.Item("C" & CreatureTarget.CurrentConvo).RemoveTopic("Q" & TopicX.Index)
									End If
								Next TopicX
							Next ConvoX
