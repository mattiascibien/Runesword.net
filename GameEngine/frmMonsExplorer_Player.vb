...
Friend Class frmMonsExplorerPlayer
	...
	Private Sub DisplayCreaInfo()
		...
		txtAge.Text = intYears & " year" & IIf(intYears > 1, "s ", " ") & intMoons & " moon" & IIf(intMoons > 1, "s ", " ") & intCycles & " cycle" & IIf(intCycles > 1, "s ", " ") & intTurns & " turn" & IIf(intTurns > 1, "s ", " ") & " adventuring!"
		txtTotalTomes.Text = CStr(CreatureX.Infos.Tomes)
		lblFights.Text = CStr(CreatureX.Infos.Battles)
		lblTotalKills.Text = CStr(CreatureX.Infos.KillsCount)
		lblTotalHits.Text = CStr(CreatureX.Infos.Hits)
		lblTotalMisses.Text = CStr(CreatureX.Infos.Misses)
		lblBattleResult.Text = IIf(CreatureX.Infos.Accuracy = -1, "N/A", CreatureX.Infos.Accuracy & "%")
		lblTotalSpells.Text = CStr(CreatureX.Infos.SpellsCast)
		lblTotalFailed.Text = CStr(CreatureX.Infos.SpellsFailed)
		lblMagicResult.Text = IIf(CreatureX.Infos.Aptitude = -1, "N/A", CreatureX.Infos.Aptitude & "%")
		lblTotalDeaths.Text = CreatureX.Infos.Deaths & IIf(CreatureX.Infos.Deaths > 1, " times", " time")
		' Items
	...
	Private Sub ShowMonsPicture(ByRef FileName As String)
		...
		If PictureFile = "" Then
			'UPGRADE_WARNING: Couldn't resolve default property of object Tome.LoadPath. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			'UPGRADE_WARNING: Dir has a new behavior. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"'
			PictureFile = Dir(Tome.LoadPath & "\creatures\" & FileName)
			If PictureFile = "" Then
			...
			Else
				'UPGRADE_WARNING: Couldn't resolve default property of object Tome.LoadPath. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				PictureFile = Tome.LoadPath & "\creatures\" & FileName
			End If
		Else
			'UPGRADE_WARNING: Couldn't resolve default property of object Tome.LoadPath. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
