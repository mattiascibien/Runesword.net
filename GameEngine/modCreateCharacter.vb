...
Module modCreateCharacter
	...
	Public Sub CreatePCLoadWorlds(Optional ByRef WorldTemp As World = Nothing)
		...
		Do Until DirName = ""
			...
			If (DirName <> "." And DirName <> "..") And oFileSys.CheckExists(gAppPath & "\roster\" & DirName, clsInOut.IOActionType.Folder, False) Then
				...
				' [Titi 2.6.0] only load selected world (this will noticeably speed the change world process up!)
				If WorldTemp Is Nothing Or (DefaultWorld = WorldX.Name And Not WorldTemp Is Nothing) Then
					...
					' [Titi 2.4.9b] Get the World Magic system defaults from the *.ini file
					lResult = fReadValue(FileName, "World", "MagicPerLevel", "S", "10", Text)
					WorldX.MagicPerLevel = CShort(Val(Text))
					lResult = fReadValue(FileName, "World", "Magic", "S", "Eternium", Text)
					WorldX.Magic = Text
					lResult = fReadValue(FileName, "World", "RandomizeMagic", "S", "0", Text)
					WorldX.RandomizeMagic = CShort(Val(Text))
					lResult = fReadValue(FileName, "World", "Runes", "S", "0", Text)
					WorldX.Runes = CShort(Val(Text))
					lResult = fReadValue(FileName, "World", "Formula", "S", "", Text)
					WorldX.Formula = Text
				...
				End If
				' [Titi 2.6.0] preferred interface
				lResult = fReadValue(FileName, "World", "InterfaceName", "S", "WoodWeave", Text)
				strInterfaceName = Text
				...
				If WorldX.Name = DefaultWorld Then
					...
					' [Titi 2.6.0] use the preferred interface (can be overridden through the options menu anyway)
					GlobalInterfaceName = strInterfaceName
				End If
			End If
			'UPGRADE_WARNING: Dir has a new behavior. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"'
			DirName = Dir()
		Loop 
		strInterfaceName = GlobalInterfaceName
	...
	Public Sub CreatePCClick(ByRef AtX As Short, ByRef AtY As Short, ByRef ButtonDown As Short)
		...
		Dim KingdomX As Kingdom
		ReDim Preserve strKingdomNames(11)
		...
		ElseIf PointIn(AtX, AtY, 52, 331, 82, 18) And TomeAction = bdCreatePCPicture And ButtonDown = True Then 
			...
			CreatureNow.Male = True
			'        CreatePCPicture CreatePictureIndex
			' [Titi 2.5.1] changing screen, select first picture
			CreatePCPicture(1)
			Call PlayClickSnd(modIOFunc.ClickType.ifClick)
...
Err_Handler: 
	...
	Private Sub CreatePCPicture(ByRef Index As Short)
		...
		' [Titi 2.5.1] only consider relevant picture files
		sPrefix = IIf(CreatureNow.Male, "???", "***")
		For c = 1 To KingdomNow.PictureFiles.Count()
			...
			If Left(BreakText(KingdomNow.PictureFiles.Item(c).Text, 1), 3) = sPrefix Then
				'UPGRADE_WARNING: Couldn't resolve default property of object KingdomNow.PictureFiles().Text. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				CreatureNow.PictureFile = Mid(BreakText(KingdomNow.PictureFiles.Item(c).Text, 1), 4)
				'UPGRADE_WARNING: Couldn't resolve default property of object KingdomNow.PictureFiles().Text. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				...
				' Show selector
				If c = CreatePictureIndex + intOffset Then
					'UPGRADE_ISSUE: PictureBox property picFaces.hdc was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
					'UPGRADE_ISSUE: PictureBox property picTomeNew.hdc was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
		...
		'UPGRADE_WARNING: Couldn't resolve default property of object KingdomNow.PictureFiles().Text. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		CreatureNow.PictureFile = Mid(BreakText(KingdomNow.PictureFiles.Item(Index + IIf(CreatureNow.Male, intOffset, 0)).Text, 1), 4)
		'UPGRADE_WARNING: Couldn't resolve default property of object KingdomNow.PictureFiles().Text. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		If IsNumeric(BreakText(KingdomNow.PictureFiles.Item(Index + IIf(CreatureNow.Male, intOffset, 0)).Text, 2)) Then
			'UPGRADE_WARNING: Couldn't resolve default property of object KingdomNow.PictureFiles().Text. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			CreatureNow.FaceLeft = CShort(BreakText(KingdomNow.PictureFiles.Item(Index + IIf(CreatureNow.Male, intOffset, 0)).Text, 2))
		End If
		'UPGRADE_WARNING: Couldn't resolve default property of object KingdomNow.PictureFiles().Text. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		If IsNumeric(BreakText(KingdomNow.PictureFiles.Item(Index + IIf(CreatureNow.Male, intOffset, 0)).Text, 3)) Then
			'UPGRADE_WARNING: Couldn't resolve default property of object KingdomNow.PictureFiles().Text. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			CreatureNow.FaceTop = CShort(BreakText(KingdomNow.PictureFiles.Item(Index + IIf(CreatureNow.Male, intOffset, 0)).Text, 3))
		End If
		Dim FileName As String
		...
		If FileName = "" Then
			...
			If FileName = "" Then
				...
				'UPGRADE_WARNING: Dir has a new behavior. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"'
				FileName = Dir(gAppPath & "\Roster\" & WorldNow.Name & "\" & CreatureNow.PictureFile)
				If FileName = "" Then
					'UPGRADE_WARNING: Dir has a new behavior. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"'
					FileName = Dir(gAppPath & "\Roster\" & WorldNow.Name & "\Creatures\" & CreatureNow.PictureFile)
					If FileName = "" Then
					...
					Else
						FileName = gAppPath & "\Roster\" & WorldNow.Name & "\Creatures\" & CreatureNow.PictureFile
					End If
				Else
					FileName = gAppPath & "\Roster\" & WorldNow.Name & "\" & CreatureNow.PictureFile
				End If
			Else
				'UPGRADE_WARNING: Couldn't resolve default property of object Tome.FullPath. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
	...
	Private Sub CreatePCSkills(ByRef Index As Short)
		...
		For c = ScrollTop To Least(ScrollTop + 9, KingdomNow.Skills.Count())
			...
			If c = Index Then
				...
				'UPGRADE_WARNING: Couldn't resolve default property of object KingdomNow.Skills().Name. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				FileName = gDataPath & "\Graphics\Skills\" & KingdomNow.Skills.Item(c).Name & ".bmp"
				frmMain.picTmp.Image = System.Drawing.Image.FromFile(FileName)
				ReadBitmapFile(FileName, bmMons, hMemMons, TransparentRGB)
				' Make a copy of the current palette for the picture
				'UPGRADE_WARNING: Couldn't resolve default property of object bmBlack. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				bmBlack = bmMons
				...
				rc = SetStretchBltMode(frmMain.picTomeNew.hdc, 3)
				'UPGRADE_ISSUE: PictureBox property picTomeNew.hdc was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				rc = StretchDIBits(frmMain.picTomeNew.hdc, 402, 232, frmMain.picTmp.Width, frmMain.picTmp.Height, 0, 0, bmMons.bmiHeader.biWidth, bmMons.bmiHeader.biHeight, lpMem, bmMask, DIB_RGB_COLORS, SRCAND)
				'UPGRADE_ISSUE: PictureBox property picTomeNew.hdc was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
				rc = StretchDIBits(frmMain.picTomeNew.hdc, 402, 232, frmMain.picTmp.Width, frmMain.picTmp.Height, 0, 0, bmMons.bmiHeader.biWidth, bmMons.bmiHeader.biHeight, lpMem, bmBlack, DIB_RGB_COLORS, SRCPAINT)
				' Release memory
				rc = GlobalUnlock(hMemMons)
				rc = GlobalFree(hMemMons)
				'            frmMain.picTomeNew.PaintPicture frmMain.picTmp, 402, 182, frmMain.picTmp.Width, frmMain.picTmp.Height
			Else
				'UPGRADE_WARNING: Couldn't resolve default property of object KingdomNow.Skills().Name. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			...
			n = n + 1
		Next c
		CreatePCLoadMap(WorldNow) ' [Titi 2.5.0] reset picTmp to the world map
...
ErrorHandler: 
	...
	Private Sub CreatePCSave()
		...
		For	Each TriggerX In CreatureX.Triggers
			...
			End If
		Next TriggerX
		' [Titi 2.4.9b] moved BEFORE the bdPostNewCharacter - we need the name of the creature!
