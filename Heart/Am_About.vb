...
Friend Class frmAbout
	...
	Private Sub frmAbout_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
		...
		lblBuild.Text = "v" & My.Application.Info.Version.Major & "." & My.Application.Info.Version.Minor & " Build " & My.Application.Info.Version.Revision
		lblDescription.Text = "License Number #" & GlobalLicNumber1 & "-" & GlobalLicNumber2 & "-" & GlobalLicNumber3 & Chr(13) & Chr(13) & "For more information and support, see us at www.crosscutgames.com."
