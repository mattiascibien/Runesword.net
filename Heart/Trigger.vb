...
Friend Class Trigger
	...
	' Bit 13    - On=Lust
	' Bit 14    - On=Fish
	' Bit 15    - On=Apply even when character is dead
	...
	Public Property Style(ByVal Index As Short) As Short
		...
		End Get
		Set(ByVal Value As Short)
			' [Titi 2.6.0] to keep backward compatibility, special case of bit 15 (sign of integer) added so it can be used as a 16th check box
			If Value Then
				If Index = 15 And myStyle >= 0 Then
					myStyle = -2 ^ Index + myStyle
				Else
	...
	Public Property DeadToo() As Short
		Get
			'    DeadToo = (myStyle And &H8000) > 0
			DeadToo = Me.Style(15)
		End Get
		Set(ByVal Value As Short)
			If Value Then
				myStyle = myStyle Or &H8000
			Else
				myStyle = myStyle And (Not &H8000)
			End If
		End Set
	End Property
