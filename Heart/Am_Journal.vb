...
Friend Class frmJournal
	...
	Public Sub ShowJournal(ByRef InTree As AxComctlLib.AxTreeView, ByRef InJournal As Journal)
		Dim OldDirt, tmpDirty As Short
		tmpDirty = Dirty '[Titi 2.4.9a]
		OldDirt = frmMDI.Dirty
		TreeViewX = InTree
		JournalX = InJournal
		txtText.Text = JournalX.Text
		SetDirty(False)
	...
	Private Sub UpdateJournal()
		JournalX.Text = txtText.Text
		' Update name in project list
		TreeViewX.Nodes(Me.Tag).Text = JournalX.Text
		SetDirty(False)
	End Sub
	...
	Private Sub btnCancel_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles btnCancel.Click
		' [Titi 2.6.3] cancelling a new journal means we won't keep it
		If VB.Right("   " & Me.Tag, 3) = "NEW" Then frmMDI.EditCut(VB.Left(Me.Tag, Len(Me.Tag) - 3))
		Me.Close()
	End Sub
	
	Private Sub btnOk_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles btnOk.Click
		' [Titi 2.6.3] cancelling a validated journal only means we won't keep the changes since the last ones so we update the tag
		If VB.Right("   " & Me.Tag, 3) = "NEW" Then Me.Tag = VB.Left(Me.Tag, Len(Me.Tag) - 3)
		UpdateJournal()
		Me.Close()
	End Sub
	
	Private Sub frmJournal_KeyUp(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyUp
	...
	Private Sub frmJournal_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
		InitGame()
	End Sub
	
	Private Sub frmJournal_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
		Dim c As Short
		' [Titi 2.4.9a]
		If Dirty Then
			...
			Else
				' [Titi 2.6.3] closing a new journal means we won't keep it
