...
Friend Class Conversation
	...
	Public Sub Copy(ByRef FromConversation As Conversation)
		...
		Next c
		' [Titi 2.6.2] update the action references
		For	Each TopicX In FromConversation.Topics
			n = n + 1
			For c = 1 To myTopics.Count()
				'UPGRADE_WARNING: Couldn't resolve default property of object myTopics.Item(c).ActionRef. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				If TopicX.Index = myTopics.Item(c).ActionRef Then
					' new numbering (rearrangement due to the copy) so need to change the links accordingly
					'UPGRADE_WARNING: Couldn't resolve default property of object myTopics.Item().ActionRef. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
					myTopics.Item(c).ActionRef = n
				End If
			Next 
		Next TopicX
	End Sub
