...
Friend Class Tome
	...
	' Bit3      -   On=IsPersistent, Off=Not IsPersistent
	' Bit4-7    -   Not Used
	...
	Public Property Year_Renamed() As Short
		Get
			Year_Renamed = myYear
		End Get
		Set(ByVal Value As Short)
	...
	Public Property IsPersistent() As Short
		Get
			IsPersistent = (myOnAdventure And &H8) > 0
		End Get
		Set(ByVal Value As Short)
			If Value Then
				myOnAdventure = myOnAdventure Or &H8
			Else
				myOnAdventure = myOnAdventure And (Not &H8)
			End If
		End Set
	End Property
