...
Friend Class Area
	...
	' File Name for this Area
	Private myFileName As String
	' Flag for if Loaded into Memory or not (not saved)
	Private myIsLoaded As Short
	...
	Public Property IsLoaded() As Short
		Get
			IsLoaded = myIsLoaded
		End Get
		Set(ByVal Value As Short)
	...
	Public Property Plot() As Plot
		Get
			Plot = myPlot
		End Get
		Set(ByVal Value As Plot)
			myPlot = Value
		End Set
	End Property
	
	Public Sub Copy(ByRef FromArea As Area)
		myName = FromArea.Name
		myPlot = FromArea.Plot
	End Sub
	...
	Public Sub SaveToFile(ByRef ToFile As Short)
		...
		'UPGRADE_WARNING: Put was upgraded to FilePut and has a new behavior. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"'
		FilePut(ToFile, Len(myFileName))
		'UPGRADE_WARNING: Put was upgraded to FilePut and has a new behavior. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"'
		FilePut(ToFile, myFileName)
		'UPGRADE_WARNING: Put was upgraded to FilePut and has a new behavior. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"'
