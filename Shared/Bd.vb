		...
		Select Case StmtX.Statement
			...
			Case 12 'Put [Context.Var] [Op] [Context.Var] Into [Context.Var]
				...
				If My.Application.Info.AssemblyName Like "Creator" Then
					'UPGRADE_WARNING: Couldn't resolve default property of object frmTriggerProp.IsReadOnly. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		...
		Select Case Context
			...
			Case 1 ' Map
				Select Case Var
					...
					Case 11 To 30 : VarToText = IIf(WorldNow.Runes, sRune(Var - 10), "Rune" & sRune(Var - 10))
			...
			Case 12 To 16 ' Creature
				Select Case Var
					...
					Case 75 : VarToText = IIf(WorldNow.Magic = "", "Eternium", WorldNow.Magic)
					...
					Case 133 : VarToText = IIf(WorldNow.Magic <> vbNullString, WorldNow.Magic, "Eternium") & "Max"
			...
			Case 28 ' Global
				Select Case Var
					...
					Case 9 To 28 : VarToText = IIf(WorldNow.Runes, sRune(Var - 8), "Rune" & sRune(Var - 8))
		...
		If KeyAscii > 0 Then
			Select Case KeyAscii
				Case System.Windows.Forms.Keys.Back, System.Windows.Forms.Keys.Delete, 45, 48 To 57
                    ...
                    If ChkText.SelectionLength > 0 Then
                        Select Case KeyAscii
