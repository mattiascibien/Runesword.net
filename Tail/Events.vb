...
Module modEvents
	...
	Private Function FindMatch(ByRef StartLine As Short, ByRef TrigToCheck As Trigger) As Short
		...
		With TrigToCheck
			...
			Loop Until ((Depth = 0) Or (i <= 0) Or (i >= .Statements.Count())) '[Titi 2.4.9b] Sure Phule, need to check boundaries!
			FindMatch = i - 1
		End With
	End Function
	...
	Public Function FireTrigger(ByRef ParentX As Object, ByRef TrigToFire As Trigger) As Short
		...
		If GlobalDebugMode = 1 Then
			...
			'UPGRADE_WARNING: Couldn't resolve default property of object DebugHeader. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
					...
					Select Case StmtX.Statement
						...
						Case 2, 4, 5, 6 ' If, ElseIf, And, Or
							...
							If CompareVars(StmtX.B(0), StmtX.B(1), StmtX.B(2), StmtX.B(3), StmtX.B(4)) <> 0 Then
								' [Titi 2.6.0.51] check if testing against Global.True
								If StmtX.B(1) = True Or StmtX.B(4) = True Then
									'UPGRADE_WARNING: Couldn't resolve default property of object CompareVars(StmtX.B(0), StmtX.B(1), StmtX.B(2), StmtX.B(3), StmtX.B(4)). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
						...
						Case 8 ' While
							...
							'UPGRADE_WARNING: Couldn't resolve default property of object CompareVars(StmtX.B(0), StmtX.B(1), StmtX.B(2), StmtX.B(3), StmtX.B(4)). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
							If CompareVars(StmtX.B(0), StmtX.B(1), StmtX.B(2), StmtX.B(3), StmtX.B(4)) < 1 Then
								' All right... let's see if having the statement jump from here does the trick.... - Phule
						...
						Case 9 ' ForEach Object In Object.Collection
							...
							Select Case StmtX.B(0)
								Case 0 To 2 ' Creatures
									...
									'UPGRADE_WARNING: Couldn't resolve default property of object ObjectX.Creatures. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
									If c > ObjectX.Creatures.Count Then
										' All right... lets see if having the statement jump from here does the trick.... - Phule
										.LoopStack(.LoopStackTop) = 0
										.StatementNow = FindMatch(.StatementNow, TrigToFire)
										StmtX = .Trigger.Statements(.StatementNow)
									End If
						...
						Case 38 ' DialogAccept
							'UPGRADE_WARNING: Couldn't resolve default property of object DialogShow(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
						...
						Case 49 ' [Titi 2.5.1] TargetEncounterNamed
							c = False
							' Find Area in Tome
							...
							For	Each AreaX In Tome.Areas
								If AreaX.Index = StmtX.B(0) + 1 Then
									'UPGRADE_WARNING: Couldn't resolve default property of object Area.Index. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
									If AreaX.Index <> Area.Index Then
										i = FreeFile
										'UPGRADE_WARNING: Couldn't resolve default property of object Tome.LoadPath. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
										FileOpen(i, Tome.LoadPath & "\" & AreaX.FileName, OpenMode.Binary)
										AreaX.Plot = New Plot
									...
									For	Each MapX In AreaX.Plot.Maps
										If MapX.Index = StmtX.B(1) + 1 Then
											' Find Encounter in Map
											For	Each EncounterX In MapX.Encounters
												If EncounterX.Index = StmtX.B(2) + 1 Then
													'UPGRADE_WARNING: Couldn't resolve default property of object AreaX.Plot.Maps().Encounters. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
													.EncounterX(4) = AreaX.Plot.Maps.Item(MapX.Index).Encounters(EncounterX.Index)
													frmMain.EncounterTargetInArea = .EncounterX(4)
													frmMain.UpdateListEncounterTarget((frmMain.EncounterTargetInArea))
													c = True
													Exit For ' EncounterX
												End If
											Next EncounterX
							...
							For	Each ConvoX In CreatureTarget.Conversations
								For	Each TopicX In ConvoX.Topics
									If InStr(UCase(TopicX.Say), UCase(BreakText(sText, 1))) > 0 Then
										'                                    CreatureTarget.Conversations(ConvoX.Index).RemoveTopic "Q" & TopicX.Index
										...
										'UPGRADE_WARNING: Couldn't resolve default property of object CreatureTarget.Conversations. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
										CreatureTarget.Conversations("C" & CreatureTarget.CurrentConvo).RemoveTopic("Q" & TopicX.Index)
									End If
								Next TopicX
							Next ConvoX
						...
						Case 72 ' CombatAnimation 'Text' For [B0] Frames [B1]
							...
							If c > -1 And frmMain.picGrid.Visible = True Then
								...
								' [Titi 2.5.0] The animation used to be loaded in the picture box used by the creature to animate. However, that same picture box was used by ALL the creatures using the same picture.
								' Bug fix: force the animation to be in a specific PictureBox (to prevent other creatures using the same picture file to animate as well).
								...
								frmMain.picCPic.Load(bdMaxMonsPics + 1)
								...
								Do Until X = Cells
									...
									X = X + 1
								Loop 
								' [Titi 2.5.0] now that the animation is over, just revert to the normal PictureBox
								'UPGRADE_WARNING: Couldn't resolve default property of object bdMaxMonsPics. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
								frmMain.picCPic.Unload(bdMaxMonsPics + 1)
								'UPGRADE_WARNING: Couldn't resolve default property of object ObjectX.Pic. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
								ObjectX.Pic = Found
								'UPGRADE_WARNING: Couldn't resolve default property of object ObjectX. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			...
			Case 0 ' =
				If IsNumeric(aa) And IsNumeric(bb) Then
					...
					If aa = bb Then
						...
						CompareVars = 1
					End If
					' [Titi 2.6.0.51] some properties, when set, give a value of +1 instead of True (-1)
					'UPGRADE_WARNING: Couldn't resolve default property of object bb. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
					'UPGRADE_WARNING: Couldn't resolve default property of object aa. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
					'UPGRADE_WARNING: Couldn't resolve default property of object CompareVars. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
					If System.Math.Abs(aa) = System.Math.Abs(bb) And aa * bb = -1 Then CompareVars = -1
				Else
					'UPGRADE_WARNING: Couldn't resolve default property of object bb. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
					'UPGRADE_WARNING: Couldn't resolve default property of object aa. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
					If UCase(VB6.Format(aa)) = UCase(VB6.Format(bb)) Then
						...
						CompareVars = 1
					End If
					' [Titi 2.6.0.52] particular case of factoids: GetVarContext retrieves ALL the factoids and put them in aa with | as a separator
					'UPGRADE_WARNING: Couldn't resolve default property of object aa. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
					sFactoid = Split(aa, "|")
					For i = 0 To UBound(sFactoid)
						'UPGRADE_WARNING: Couldn't resolve default property of object bb. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
						'UPGRADE_WARNING: Couldn't resolve default property of object CompareVars. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
						If sFactoid(i) = bb Then CompareVars = 1
					Next 
				End If
			Case 1 ' +
				If IsNumeric(aa) And IsNumeric(bb) Then
		...
		Select Case AsContext
			...
			Case 1 'Map
				Select Case AsVar
					...
					Case 35 ' CanCamp [Titi 2.5.1]
						...
						GetVarContext = System.Math.Abs(Map.CanCamp)
				End Select
			...
			Case 7, 8, 9, 10, 11 'EncounterNow, EncounterA, EncounterB, EncounterC, EncounterTarget
				...
				Select Case AsVar
					...
					Case 7 ' CanCamp [Titi 2.5.1]
						'UPGRADE_WARNING: Couldn't resolve default property of object ObjectX.CanCamp. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
						GetVarContext = System.Math.Abs(ObjectX.CanCamp)
					Case 8 ' IsDark
			...
			Case 12, 13, 14, 15, 16 'CreatureNow, CreatureA, CreatureB, CreatureC, CreatureTarget
				...
				' [Titi 2.5.1] calculate the age of the creature
				'UPGRADE_WARNING: Couldn't resolve default property of object ObjectX.Infos. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				intTurns = ObjectX.Infos.Age
				...
				Select Case AsVar
					...
					Case 40 ' AgeYear [Titi 2.5.1]
						'UPGRADE_WARNING: Couldn't resolve default property of object GetVarContext. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
						GetVarContext = intYears
					Case 41 ' AgeMoon [Titi 2.5.1]
						'UPGRADE_WARNING: Couldn't resolve default property of object GetVarContext. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
						GetVarContext = intMoons
					Case 42 ' AgeCycle [Titi 2.5.1]
						'UPGRADE_WARNING: Couldn't resolve default property of object GetVarContext. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
						GetVarContext = intCycles
					Case 43 ' AgeTurn [Titi 2.5.1]
						'UPGRADE_WARNING: Couldn't resolve default property of object GetVarContext. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
						GetVarContext = intTurns
			...
			Case 17, 18, 19, 20, 21 'ItemNow, ItemA, ItemB, ItemC, ItemTarget
				...
				Select Case AsVar
					...
					Case 4 To 8 ' Size [Titi 2.4.9b]
						'GetVarContext = Abs(ObjectX.Size(AsVar - 4))
						'UPGRADE_WARNING: Couldn't resolve default property of object ObjectX.Size. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
						GetVarContext = System.Math.Abs(CInt(ObjectX.Size = AsVar - 3))
					Case 9 ' All Sizes can use [Titi 2.4.9b]
						'UPGRADE_WARNING: Couldn't resolve default property of object ObjectX.SizeBit. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
						GetVarContext = System.Math.Abs(CInt((ObjectX.SizeBit(9) And 512) <> 0))
					Case 10 ' Min level required to use [Titi 2.4.9b]
						'UPGRADE_WARNING: Couldn't resolve default property of object ObjectX.MinLevel. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
						'UPGRADE_WARNING: Couldn't resolve default property of object GetVarContext. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
						GetVarContext = ObjectX.MinLevel
					Case 16 ' Capacity
		...
		Select Case IntoContext
			...
			Case 7, 8, 9, 10, 11 'EncounterNow, EncounterA, EncounterB, EncounterC, EncounterTarget
				...
				Select Case IntoVar
					...
					Case 7 ' Not Used --> Now CanCamp [Titi 2.5.1]
						'UPGRADE_WARNING: Couldn't resolve default property of object ObjectX.CanCamp. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
						ObjectX.CanCamp = (sInteger <> 0)
					Case 8 ' IsDark
						'UPGRADE_WARNING: Couldn't resolve default property of object ObjectX.IsDark. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			...
			Case 12, 13, 14, 15, 16 'CreatureNow, CreatureA, CreatureB, CreatureC, CreatureTarget
				...
				Select Case IntoVar
					...
					Case 23 ' HealthNow
						...
						' [Titi 2.6.1] in case the creature gets killed through a trigger, it wouldn't be changed into a corpse
						If sInteger <= 0 Then
							'UPGRADE_WARNING: Couldn't resolve default property of object ObjectX. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
							frmMain.UpdateCreatureInfo(ObjectX, False)
						End If
						frmMain.MenuDrawParty()
					Case 24 ' HealthMax
						'UPGRADE_WARNING: Couldn't resolve default property of object ObjectX.HPMax. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
					...
					Case 32 To 39 ' ResistanceSharp, Blunt, Cold, Fire, Evil, Holy, Magic, Mind
						' Read Only
					Case 40 ' AgeYear [Titi 2.5.1]
						'ObjectX.Infos.Age = CLng(sInteger * 200 * 50 * 10) + CLng(intMoons * 50 * 200 + intCycles * 200 + intTurns)
					Case 41 ' AgeMoon [Titi 2.5.1]
						'ObjectX.Infos.Age = CLng(sInteger * 200 * 50) + CLng(intCycles * 200 + intTurns + intYears * 200 * 50 * 10)
					Case 42 ' AgeCycles [Titi 2.5.1]
						'ObjectX.Infos.Age = CLng(sInteger * 200) + CLng(intTurns + intMoons * 50 * 200 + intYears * 200 * 50 * 10)
					Case 43 ' AgeTurn [Titi 2.5.1]
						'ObjectX.Infos.Age = CLng(sInteger) [Titi 2.5.1] Finally decided this should stay read-only
					Case 46 ' IsTypeAnimal
						'UPGRADE_WARNING: Couldn't resolve default property of object ObjectX.Family. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
					...
					Case 157 ' PictureFile
						' Validate Picture
						Found = True
						' [Titi 2.4.9b] update RuneScript to account for all the options
						'UPGRADE_WARNING: Couldn't resolve default property of object Tome.LoadPath. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
						...
						If Dir(Tome.LoadPath & "\" & sText) = "" Then
							...
							If Dir(Tome.LoadPath & "\creatures\" & sText) = "" Then
								'UPGRADE_WARNING: Dir has a new behavior. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"'
								If Dir(gAppPath & "\Roster\" & WorldNow.Name & "\" & sText) = "" Then
									'UPGRADE_WARNING: Dir has a new behavior. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"'
									If Dir(gAppPath & "\Roster\" & WorldNow.Name & "\Creatures\" & sText) = "" Then
			...
			Case 17, 18, 19, 20, 21 'ItemNow, ItemA, ItemB, ItemC, ItemTarget
				...
				Select Case IntoVar
					...
					Case 3 ' ArmorType
						' Read Only
						' [Titi 2.4.9b] size added
					Case 4 To 9 ' Size
						'UPGRADE_WARNING: Couldn't resolve default property of object ObjectX.Size. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
						ObjectX.Size = sInteger
						' [Titi 2.4.9b] level added
						'UPGRADE_WARNING: Couldn't resolve default property of object ObjectX.MinLevel. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
						ObjectX.MinLevel = sInteger
					Case 16 ' Capacity
						'UPGRADE_WARNING: Couldn't resolve default property of object ObjectX.Capacity. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			...
			Case 28 'Global
				Select Case IntoVar
					...
					Case 64 ' DayName
						...
						GlobalAutoCenter = GlobalAutoCenter Or 32 ' [Titi 2.6.0] flag to keep the change
					Case 65 ' MoonName
						'UPGRADE_WARNING: Couldn't resolve default property of object GlobalMoonName. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
						GlobalMoonName = sText
						'UPGRADE_WARNING: Couldn't resolve default property of object GlobalAutoCenter. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
						GlobalAutoCenter = GlobalAutoCenter Or 64 ' [Titi 2.6.0] flag to keep the change
					Case 66 ' YearName
						'UPGRADE_WARNING: Couldn't resolve default property of object GlobalYearName. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
						GlobalYearName = sText
						'UPGRADE_WARNING: Couldn't resolve default property of object GlobalAutoCenter. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
						GlobalAutoCenter = GlobalAutoCenter Or 128 ' [Titi 2.6.0] flag to keep the change
					Case 67 ' TurnName
						'UPGRADE_WARNING: Couldn't resolve default property of object GlobalTurnName. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
						GlobalTurnName = sText
						'UPGRADE_WARNING: Couldn't resolve default property of object GlobalAutoCenter. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
						GlobalAutoCenter = GlobalAutoCenter Or 16 ' [Titi 2.6.0] flag to keep the change
					Case 68 ' PickLockChance
						'UPGRADE_WARNING: Couldn't resolve default property of object GlobalPickLockChance. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
